...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "room_cookie"
			;[Block]
			d = CreateDoor(r\zone, r\x + 256 * RoomScale, 0, r\z - 256 * RoomScale, 90, r, False, 0, 3)
			;[End Block]
	End Select
...
Function CreateMap()
	...
	SetRoom("room_cookie", ROOM1, Floor(0.4*Float(Room1Amount[0])),min_pos,max_pos)
